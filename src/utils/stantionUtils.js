...
export function eventDivisions(props) {
  ...
  stansions
    .on('mouseenter', function () {
      stMousein(this, props.stantionItems)
    })
    .on('mouseleave', stMouseout)
    .on('click', function () {
      stClick(this, props)
    })
}

function stMousein(element, stantion) {
...
function stClick(element, props) {
...
function nodeClick(element, props) {
